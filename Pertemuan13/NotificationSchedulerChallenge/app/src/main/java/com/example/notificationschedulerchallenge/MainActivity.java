package id.ac.poliban.mi.vd.denny.notificationschedulerchallenge;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Denny - Notification Scheduler Challenge");
    ...
    public void scheduleJob(View view) {
        ...
        ComponentName componentName = new ComponentName(getPackageName(),
                id.ac.poliban.mi.vd.denny.notificationschedulerchallenge.SleeperJobScheduler.class.getName());
